...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "HVPltd0Dl6B3HqLRDk3elOGyL", consumerSecret: "CwY8D4OW07Ae1neD9mPbJSZatAmvPv2UCIcZqWPW7kpHIaDx0S")
    var loginSuccess: (() -> ())?
